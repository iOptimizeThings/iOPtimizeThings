...
* **Optimization:** Reducing critical query runtimes by **96%** (5 mins → <10s).
* **Systems:** Low-level C/C# integration for banking host systems.

For a detailed breakdown of my technical capabilities, please refer to my **Resume** or **LinkedIn**.
